...
import { ArrowLeft, Calendar, Clock, MapPin, Plus, Minus } from 'lucide-react-native';

const bookingData = {
  vendor: {
    name: 'Fresh Dairy Farm',
    service: 'Fresh Cow Milk',
    price: 55,
    unit: 'per litre',
  },
  deliverySlots: [
  ...
  subscriptionOptions: [
    ...
    { id: 'alternate', label: 'Alternate Days', description: 'Every 2nd day delivery' },
    { id: 'weekly', label: 'Weekly', description: 'Once a week delivery' },
    { id: 'monthly', label: 'Monthly', description: 'Once a month delivery' },
  ],
};

export default function MilkBookingScreen() {
  const { vendorId } = useLocalSearchParams();
  const [bookingType, setBookingType] = useState<'subscription' | 'onetime'>('subscription');
  ...
  const calculateTotal = () => {
    const basePrice = bookingData.vendor.price * quantity;
  ...
  const handleProceedToPayment = () => {
    ...
    router.push({
      pathname: '/services/milk/payment',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.serviceCard}>
          ...
          <Text style={styles.servicePrice}>₹{bookingData.vendor.price} {bookingData.vendor.unit}</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quantityContainer}>
            ...
            >
              <Minus size={20} color={Colors.primary[600]} />
            </TouchableOpacity>
            <Text style={styles.quantityText}>{quantity} L</Text>
            <TouchableOpacity
              style={styles.quantityButton}
          ...
          <View style={styles.priceCard}>
            <View style={styles.priceRow}>
              <Text style={styles.priceLabel}>
                {bookingData.vendor.service} × {quantity}L
              </Text>
              <Text style={styles.priceValue}>₹{bookingData.vendor.price * quantity}</Text>
            </View>
            <View style={styles.priceRow}>
